...
GPSTimeZoneLookup::GPSTimeZoneLookup(float lat, float long){
// find the city from the city list closest to our coordinates
    ...
    Serial.print("GPSTimeZoneLookup: coordinates: ");
    Serial.print(myLat);
    Serial.print(", ");
    ...
    for (int ii = 0; ii < _numCities; ii++) {
        ...
        thisDistance = GPSTimeZoneLookup::distanceBetween(myLat,myLong,_cityCoords[ii][0],_cityCoords[ii][1]);
    ...
    Serial.print(_closestCityLat);
    Serial.print(", ");
    Serial.println(_closestCityLong);
